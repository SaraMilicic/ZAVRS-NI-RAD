   ...
   <div class="util-container">
    ...
    <h1>Rezultati pretrage</h1>
        ...
        pronađi sve sobe i hotele koje nemaju rezervaciju u tražeom periodu*/
            ...
            $results1 = ORM::for_table('hotel')->raw_query('SELECT r.*, h.* from room r
            join hotel r on r.id_hotel = h.id
            ...
            */
            ...
            $results2 = ORM::for_table('room')->raw_query('SELECT r.*, h.* FROM room r
            join city c on h.postal_code = c.postal_code
