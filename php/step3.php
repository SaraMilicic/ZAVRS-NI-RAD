   ...
   <div class="container">
        <div class="row">
            ...
            require_once 'db_conn.php';
                    ...
                    echo '<div class="col-md-4"><a href="reservation_step_one.php?room_id=2"><h1>1. Odabir sobe</h1></a></div>
                <div class="col-md-4"><a href="reservation_step_two.php" class="not-active"><h1>2. Osobni podaci</h1></a></div>
                <div class="col-md-4"><a href="reservation_step_three.php" class="not-active"><h1 style="color:black;">3. Potvrda rezervacije</h1></a></div>';
         

                    echo '<div class="col-md-12">
                        <h3>Rezervacija:</h3>
                        <p>Hotel: Hotel Zagreb</p>
                        Odabrana soba: Dvokrevetna soba</p>
                        <p>Kat: 1.kat</p>
                        ...
                        <p>Ime: Sara</p>
                        <p>Prezime: Miličić</p>
                        <p>Broj putovnice: 123456789</p>
                        <p>Broj telefona: 099123123</p>
                                                <input type="submit" class="btn btn-primary" id="next" value="Potvrdi" style="float:right;" name="submit">

                        <p>Email: sara.milicic@mail.com</p>
                    </div>';
