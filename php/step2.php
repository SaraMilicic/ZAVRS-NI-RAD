   ...
   <div class="container">
        <div class="row">
            ...
            require_once 'db_conn.php';
                ...
                <div class="col-md-4"><a href="reservation_step_two.php" class="not-active"><h1 style="color:black;">2. Osobni podaci</h1></a></div>
                <div class="col-md-4"><a href="reservation_step_three.php" class="not-active"><h1>3. Potvrda rezervacije</h1></a></div>';
                    ...
                    <form class="row form" role="form" method="POST" action="reservation_step_three.php">
                            ...
                            <div class="col-md-12">
                            <input type="submit" class="btn btn-primary" id="next" value="Nastavi"  name="submit" style="float:right;">
                            </div>
