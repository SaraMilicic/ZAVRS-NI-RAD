...
--
-- Host: localhost:8889
-- Generation Time: Aug 25, 2016 at 09:49 PM
...
INSERT INTO `hotel` (`id`, `name`, `about`, `category`, `address`, `image`, `postal_code`) VALUES
(1, 'Hotel Rovinj', 'Opis Hotela Rovinj', 5, 'Rovinjska 10', '', 52210),
(2, 'Hotel Dubrovnik', 'Opis Hotela Dubrovnik', 5, 'Dubrovačka 10', '', 20000),
(3, 'Hotel Zagreb', 'Opis Hotela Zagreb', 5, 'Zagrebačka 10', '', 10000),
(4, 'Hotel Osijek', 'Opis Hotela Osijek', 5, 'Osječka 10', '', 31000);
...
INSERT INTO `state` (`id`, `name`, `country_code`) VALUES
(1, 'Hrvatska', '385');
